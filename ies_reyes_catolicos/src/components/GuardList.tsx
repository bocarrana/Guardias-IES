                                                                        ...
                                                                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, minWidth: 0 }}>
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                style={{
                                                                                    ...
                                                                                    borderRadius: 6,
                                                                                    width: isPantallaRole(currentUser?.role) ? 22 : 18,
                                                                                    height: isPantallaRole(currentUser?.role) ? 22 : 18,
                                                                                    minWidth: isPantallaRole(currentUser?.role) ? 22 : 18,
                                                                                    minHeight: isPantallaRole(currentUser?.role) ? 22 : 18,
                                                                                    padding: 0,
                                                                                    boxSizing: 'border-box',
                                                                                    cursor: 'pointer',
                                                                                    display: 'inline-flex',
